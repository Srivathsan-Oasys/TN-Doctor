...
import com.hmis_tn.doctor.databinding.DialogCovidSearchListBinding
import com.hmis_tn.doctor.retrofitCallbacks.RetrofitCallback
import com.hmis_tn.doctor.ui.dashboard.model.registration.CovidRegistrationSearchResponseContent
...
class SearchPatientListDialogFragment : DialogFragment() {
    ...
    override fun onCreateView(
        ...
        if (args == null) {
            ...
            viewModel?.getAllSearchCovidPatientList(
                Str_MobileNumber,
                Str_PinNumber,
                CovidSearchNameCallBack,
                Str_name
            )
        }
