...
import com.hmis_tn.doctor.ui.emr_workflow.admission_referal.model.nurse_desk.WardBedInfo


class ManageFloorBedAllocateAdapter(
    context: Context, private var responseContents: MutableList<WardBedInfo> = ArrayList()
) :
    RecyclerView.Adapter<ManageFloorBedAllocateAdapter.MyViewHolder>() {
...
*/
    ...
    */
    ...
    /*   fun getPosition(warddata:WardBedInfo): Int {
           ...
           for(i in responseContents!!.indices){
               ...
               if(responseContents[i].bed_number==warddata.bed_number){
