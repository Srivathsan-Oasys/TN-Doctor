...
*/
    ...
    interface OnItemViewClickListner {
        fun onItemClick(responseContent: com.hmis_tn.doctor.ui.emr_workflow.investigation.model.TempDetails?)
    }
    ...
    private fun viewItem(response: com.hmis_tn.doctor.ui.emr_workflow.investigation.model.TempDetails) {
