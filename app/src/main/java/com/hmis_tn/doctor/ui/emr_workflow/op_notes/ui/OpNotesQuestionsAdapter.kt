...
import com.hmis_tn.doctor.ui.emr_workflow.op_notes.model.ProfileSectionCategory
import com.hmis_tn.doctor.ui.emr_workflow.op_notes.model.ProfileSectionCategoryConcept
import com.hmis_tn.doctor.ui.emr_workflow.op_notes.model.ProfileSectionCategoryConceptValue
import com.hmis_tn.doctor.ui.emr_workflow.op_notes.model.prev_records.observed_values.ResponseContent
import com.hmis_tn.doctor.utils.Utils
import kotlinx.android.synthetic.main.dialog_comment.*
import kotlinx.android.synthetic.main.item_op_notes_questions.view.*
import java.util.*
import kotlin.collections.ArrayList

class OpNotesQuestionsAdapter(
    ...
    RecyclerView.Adapter<OpNotesQuestionsAdapter.MyViewHolder>() {

    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_op_notes_questions, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (profileSectionCategoryConcept.is_mandatory == true) {
            ...
            profileSectionCategoryConcept.profile_section_category_uuid?.let {
                opNotesChildFragment.mandatoryQuestions[it] = false
            }
        } else {
            ...
            et.addTextChangedListener(object : TextWatcher {
                override fun afterTextChanged(s: Editable?) {
                    if (s?.isNotEmpty() == true) {
                        opNotesChildFragment.formReqPayload(
                            profileSection,
                    ...
                    profileSectionCategoryConcept.profile_section_category_uuid?.let {
                        opNotesChildFragment.mandatoryQuestions[it] = s?.isNotEmpty() == true
                    }
                }
...
//            ll.addView(label)
            ...
            observedValueList?.forEach { responseContent: ResponseContent ->
                if (profileSectionCategoryConceptValue.profile_section_category_concept_uuid ==
                    responseContent.profile_section_category_concept_uuid
                ) {
                    et.setText(responseContent.term_key)
...
//        hsv.addView(ll)
        ...
        profileSectionCategoryConcept.profile_section_category_concept_values?.forEach { profileSectionCategoryConceptValue ->
            ...
            profileSectionCategoryConcept.profile_section_category_uuid?.let {
                opNotesChildFragment.mandatoryQuestions[it] = true
            }
        }
        holder.itemView.linearLayoutQuestions.addView(ll)
    }
