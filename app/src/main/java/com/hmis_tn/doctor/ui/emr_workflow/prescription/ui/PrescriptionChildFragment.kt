...
import com.hmis_tn.doctor.databinding.FragmentPrescriptionChildBinding
...
import com.hmis_tn.doctor.ui.emr_workflow.prescription.ui.dialogFragment.templeteEdit.ManagePreTempAddEdit
...
//
            ...
            binding?.saveTemplateCardView?.setOnClickListener {
                ...
                val getData = prescriptionTabAdapter?.getItems()?.size!!
            ...
            binding?.saveCardView!!.setOnClickListener {
                ...
                for (i in saveData!!.indices) {
                    if (saveData!![i]!!.drug_active!!) {
                        val ck = InjectionList.any { it.uuid == saveData!![i]!!.selectInvestID }
                        if (!ck) {
            ...
            binding?.saveTemplateCardView?.setOnClickListener {
                val listData = prescriptionMobileAdapter!!.getItems()
                if (listData.size > 0) {
                    val ft = childFragmentManager.beginTransaction()
            ...
            prescriptionMobileAdapter?.setOnRefreshClickListener(
                object : PrescriptionMobileAdapter.OnRefreshClickListener {
