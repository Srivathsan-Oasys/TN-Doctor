...
import com.hmis_tn.doctor.databinding.DialogManageRadiologyFavouritesBinding
...
import com.hmis_tn.doctor.ui.emr_workflow.lab.ui.RadiologyManageFavAdapter
...
import com.hmis_tn.doctor.ui.emr_workflow.radiology.view_model.ManageRadiologyFavourteViewModel
import com.hmis_tn.doctor.ui.emr_workflow.radiology.view_model.ManageRadiologyFavourteViewModelFactory
...
class ManageRadiolgyFavouriteFragment : DialogFragment() {
    ...
    val header: com.hmis_tn.doctor.ui.emr_workflow.radiology.model.Headers? =
        com.hmis_tn.doctor.ui.emr_workflow.radiology.model.Headers()
    val detailsList: ArrayList<com.hmis_tn.doctor.ui.emr_workflow.radiology.model.Detail> =
        ArrayList()
        ...
        binding?.addbutton?.setOnClickListener {
            ...
            if (status as Boolean) {
                if (Str_auto_id == 0) {
                    ...
                    val details: com.hmis_tn.doctor.ui.emr_workflow.radiology.model.Detail =
                        com.hmis_tn.doctor.ui.emr_workflow.radiology.model.Detail()
