...
class LabListAdapter(
    val context: Context,
    private var listOfficeItems: ArrayList<com.hmis_tn.doctor.ui.institution.lmis.model.LocationMaster?>
) : BaseAdapter() {
    ...
    fun setDepatmentListDetails(responseContents: ArrayList<com.hmis_tn.doctor.ui.institution.lmis.model.LocationMaster?>?) {
        this.listOfficeItems = responseContents!!
        this.listOfficeItems.add(com.hmis_tn.doctor.ui.institution.lmis.model.LocationMaster())
        notifyDataSetChanged()
    }

    fun getlistDetails(): List<com.hmis_tn.doctor.ui.institution.lmis.model.LocationMaster?> {
