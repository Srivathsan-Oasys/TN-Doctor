package com.hmis_tn.doctor.ui.institution.lmis.view.adapter
...
class SelectInstituteDropDownAdapter(
    val context: Context,
    var listOfficeItems: ArrayList<InstitutionresponseContent?>
) : BaseAdapter() {
