...
data class LabTestresponseContent(
    ...
    val sample_transport_details_uuid: Int? = 0,
    val send_approver_uuid: Int? = 0,
    val specimen_type_code: String? = "",
    val specimen_type_name: String? = "",
    val specimen_type_uuid: Int? = 0,
    val st_from_facility_code: String? = "",
    val st_from_facility_name: String? = "",
    val st_from_facility_uuid: Int? = 0,
    ...
    val to_facility_code: String? = "",
    val to_facility_name: String? = "",
    val to_facility_uuid: Int? = 0,
    ...
    var checkboxRejectdtatus : Boolean?=false
)