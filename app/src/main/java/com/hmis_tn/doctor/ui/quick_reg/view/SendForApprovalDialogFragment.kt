...
import com.hmis_tn.doctor.databinding.DialogSendApprovalListBinding
...
import com.hmis_tn.doctor.ui.quick_reg.model.labtest.response.UserProfileResponse
import com.hmis_tn.doctor.ui.quick_reg.model.labtest.response.UserProfileResponseModel
import com.hmis_tn.doctor.ui.quick_reg.model.request.DoctorListAdapter
...
//            dialog.window?.attributes?.windowAnimations = R.style.CardDialogAnimation
    ...
    override fun onCreateView(
        ...
        responseAdapter =
            ...
            DoctorListAdapter(
                this.requireContext(), R.layout.row_chief_complaint_search_result,
                ArrayList()
            )
        ...
        binding?.saveCardView?.setOnClickListener {
            ...
            if (binding!!.doctorName.text.toString() != "" && selectDoctorId != 0) {
                ...
                Toast.makeText(this.context, "Please Select Valid Doctor Name", Toast.LENGTH_SHORT)
                    .show()
            }
