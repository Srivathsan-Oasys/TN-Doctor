...
import com.hmis_tn.doctor.databinding.ActivityResultDispatchBinding
import com.hmis_tn.doctor.retrofitCallbacks.RetrofitCallback
import com.hmis_tn.doctor.ui.resultdispatch.model.ResponseContentsResultDispatch
...
import com.hmis_tn.doctor.ui.resultdispatch.viewmodel.ResultDispatchViewModel
import com.hmis_tn.doctor.ui.resultdispatch.viewmodel.ResultDispatchViewModelFactory
import com.hmis_tn.doctor.ui.sample_dispatch.ui.ResultDispatchAdapter
...
class ResultDispatchActivity : Fragment() {

    var binding: ActivityResultDispatchBinding? = null
    ...
    override fun onCreateView(
        ...
        binding =
            DataBindingUtil.inflate(
                inflater,
                R.layout.activity_result_dispatch,
                container,
                false
            )
        viewModel = ResultDispatchViewModelFactory(
...
//                    visitHistoryAdapter.removeLoadingFooter()
            ...
            override fun onBadRequest(response: Response<ResponseResultDispatch>?) {
                isLoadingPaginationAdapterCallback = false
                mAdapter?.removeLoadingFooter()
                isLoading = false
                isLastPage = true
