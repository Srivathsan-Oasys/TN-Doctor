...
import com.hmis_tn.doctor.data.networking.api.req.ReqAppointmentCancel
import com.hmis_tn.doctor.data.networking.api.req.ReqAppointmentCheckIn
...
import com.hmis_tn.doctor.ui.telemedicine.booking.adapter.AdapterPatientListAppointment
import com.hmis_tn.doctor.ui.telemedicine.booking.fragment.AppointmentMainSearchFragment.Companion.APPOINTMENT_BOOKED
    ...
    private fun subscribeToSessionListAPI() {
        viewModelAppointment.getAppointmentBooked(
            ...
            if (it.statusCode == 200) {
                tvAppointmentListCount.text = it.totalRecords.toString()
