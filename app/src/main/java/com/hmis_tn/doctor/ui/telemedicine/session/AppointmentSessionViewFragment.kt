...
import com.hmis_tn.doctor.data.networking.api.req.ReqViewSession
...
import com.hmis_tn.doctor.ui.telemedicine.session.AppointmentSessionCreateDialogFragment.Companion.APPOINTMENT_SESSION_DIALOG
...
class AppointmentSessionViewFragment : Fragment() {
    ...
    private val viewModelAppointment by viewModel<com.hmis_tn.doctor.ui.telemedicine.AppointmentViewModel>()
