...
import com.oasys.digihealth.doctor.ui.emr_workflow.anesthesia_notes.model.ProfileSectionCategoryConcept
import com.oasys.digihealth.doctor.ui.emr_workflow.anesthesia_notes.model.ProfileSectionCategoryConceptValue
...
import kotlinx.android.synthetic.main.item_anesthesia_notes_questions.view.*
import java.util.*
import kotlin.collections.ArrayList

class AnesthesiaNotesQuestionsAdapter(
    ...
    RecyclerView.Adapter<AnesthesiaNotesQuestionsAdapter.MyViewHolder>() {

    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_anesthesia_notes_questions, parent, false)
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        if (profileSectionCategoryConcept.is_mandatory == true) {
            ...
            profileSectionCategoryConcept.profile_section_category_uuid?.let {
                anesthesiaNotesChildFragment.mandatoryQuestions[it] = false
            }
        } else {
            ...
            et.addTextChangedListener(object : TextWatcher {
                override fun afterTextChanged(s: Editable?) {
                    if (s?.isNotEmpty() == true) {
                        anesthesiaNotesChildFragment.formReqPayload(
                            profileSection,
                    ...
                    profileSectionCategoryConcept.profile_section_category_uuid?.let {
                        anesthesiaNotesChildFragment.mandatoryQuestions[it] =
                            s?.isNotEmpty() == true
                    }
                }
...
//        hsv.addView(ll)
        ...
        profileSectionCategoryConcept.profile_section_category_concept_values?.forEach { profileSectionCategoryConceptValue ->
            ...
            profileSectionCategoryConcept.profile_section_category_uuid?.let {
                anesthesiaNotesChildFragment.mandatoryQuestions[it] = true
            }
        }
        holder.itemView.linearLayoutQuestions.addView(ll)
    }
