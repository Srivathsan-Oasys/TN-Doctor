...
class DiagnosisMobileAdapter(
    private val context: Activity,
    private val favouritesArrayList: ArrayList<DiagnosisListData?>
) :
    RecyclerView.Adapter<DiagnosisMobileAdapter.MyViewHolder>() {
    ...
    private var onCommandClickListener: DiagnosisMobileAdapter.OnCommandClickListener? = null
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(context)
            .inflate(R.layout.row_diagnosis_list, parent, false)
...
//            holder.typeTextView.text = "Snomed"
    ...
    fun setUnSelectedBackground(holder: DiagnosisMobileAdapter.MyViewHolder) {
    ...
    fun setSelectedBackground(holder: DiagnosisMobileAdapter.MyViewHolder) {
        holder.itemView.cv_outer_view.setBackgroundColor(
            ContextCompat.getColor(
                context,
    ...
    fun seterrorBackground(holder: DiagnosisMobileAdapter.MyViewHolder) {
        holder.itemView.cv_outer_view.setBackgroundColor(
            ContextCompat.getColor(
                context,
                R.color.red
    ...
    fun setSelectedAndErrorBackground(holder: DiagnosisMobileAdapter.MyViewHolder) {
        holder.itemView.cv_outer_view.setBackgroundColor(
            ContextCompat.getColor(
                context,
                R.color.red
    ...
    fun setOnCommandClickListener(onCommandClickListener: DiagnosisMobileAdapter.OnCommandClickListener) {
