...
class DurationAllergyAdapter(
    private val context: Context,
    private var durationArrayList: List<PeriodresponseContent?>?
) : RecyclerView.Adapter<DurationAllergyAdapter.MyViewHolder>() {
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        holder.durationTextView.text = responseContent.name!![0].toString()
    ...
    fun setDurationData(responseContent: List<PeriodresponseContent?>?) {
        ...
        selectedPosition = 0
        this.durationArrayList = responseContent
