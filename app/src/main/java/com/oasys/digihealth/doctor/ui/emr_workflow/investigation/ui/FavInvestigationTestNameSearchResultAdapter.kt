...
class FavInvestigationTestNameSearchResultAdapter(
    context: Context, @LayoutRes private val layoutResource: Int,
    private val allPois: List<InvestigationSearchResponseContent>
) :
    ArrayAdapter<InvestigationSearchResponseContent>(context, layoutResource, allPois),
    Filterable {
    private var mPois: List<InvestigationSearchResponseContent> = allPois

    override fun getCount(): Int {
        return mPois.size
    }

    override fun getItem(p0: Int): InvestigationSearchResponseContent? {
        return mPois.get(p0)
    }
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun publishResults(
                ...
                mPois = filterResults.values as List<InvestigationSearchResponseContent>
