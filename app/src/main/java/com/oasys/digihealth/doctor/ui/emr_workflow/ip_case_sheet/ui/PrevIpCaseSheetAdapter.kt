...
import com.oasys.digihealth.doctor.ui.emr_workflow.ip_case_sheet.model.prev_records.ResponseContent
import kotlinx.android.synthetic.main.item_prev_op_notes.view.*

class PrevIpCaseSheetAdapter(
    private val list: ArrayList<ResponseContent>,
    private val view: (ResponseContent) -> Unit
) :
    RecyclerView.Adapter<PrevIpCaseSheetAdapter.MyViewHolder>() {

    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_prev_ip_case_sheet, parent, false)
