...
import com.oasys.digihealth.doctor.ui.emr_workflow.mrd.models.CheifComplaintsDetail


class MrdChiefComplaintChildAdapter(
    private val mContext: Context,
    private var PatientList: List<CheifComplaintsDetail?>? = ArrayList()


) : RecyclerView.Adapter<MrdChiefComplaintChildAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemLayout = LayoutInflater.from(mContext).inflate(
            R.layout.mrd_chief_complaint_recycler_list_child_recycler_list,
            parent,
            false
        ) as ConstraintLayout
