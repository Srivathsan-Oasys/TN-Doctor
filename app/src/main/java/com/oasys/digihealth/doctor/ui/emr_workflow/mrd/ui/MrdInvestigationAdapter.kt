...
import com.oasys.digihealth.doctor.ui.emr_workflow.mrd.models.InvestigationDetail


class MrdInvestigationAdapter(
    private val mContext: Context

) : RecyclerView.Adapter<MrdInvestigationAdapter.MyViewHolder>() {
    private val mLayoutInflater: LayoutInflater
    internal lateinit var orderNumString: String
    private var PatientList: List<InvestigationDetail?>? = ArrayList()
    ...
    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view) {
        ...
        init {
            ...
            recyclerView = view.findViewById(R.id.investigation_child_recycler)
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemLayout = LayoutInflater.from(mContext).inflate(
            R.layout.mrd_investigation_recycler_list,
            parent,
            false
        ) as LinearLayout
    ...
    override fun onBindViewHolder(holder: MyViewHolder, position: Int) {
        ...
        val myOrderChildAdapter = MrdInvestigationChildAdapter(
            mContext,
    ...
    fun refreshList(preLabArrayList: List<InvestigationDetail?>) {
