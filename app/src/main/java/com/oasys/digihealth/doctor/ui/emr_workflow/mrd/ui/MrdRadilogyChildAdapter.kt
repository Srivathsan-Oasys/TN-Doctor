...
import com.oasys.digihealth.doctor.ui.emr_workflow.mrd.models.PatientOrderTestDetailXX


class MrdRadilogyChildAdapter(
    private val mContext: Context,
    private var PatientList: List<PatientOrderTestDetailXX?>? = ArrayList()


) : RecyclerView.Adapter<MrdRadilogyChildAdapter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemLayout = LayoutInflater.from(mContext).inflate(
            R.layout.mrd_radiology_child_recycler_list,
            parent,
            false
        ) as ConstraintLayout
