...
import com.oasys.digihealth.doctor.ui.emr_workflow.op_notes.model.prev_records.ResponseContent
import kotlinx.android.synthetic.main.item_prev_op_notes.view.*

class PrevOpNotesAdapter(
    private val list: ArrayList<ResponseContent>,
    private val view: (ResponseContent) -> Unit
) :
    RecyclerView.Adapter<PrevOpNotesAdapter.MyViewHolder>() {

    class MyViewHolder(view: View) : RecyclerView.ViewHolder(view)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.item_prev_op_notes, parent, false)
