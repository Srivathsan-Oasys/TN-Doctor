...
import com.oasys.digihealth.doctor.databinding.DialogManageTreatmentkitDiagonosisFavouritesBinding
...
import com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.model.response.TreaFavAddedResponseModel
import com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.model.response.TreatmentNameResponseModel
import com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.model.response.TreatmentNameresponseContent
import com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.view_model.TreatKitFavAddDialogViewModel
import com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.view_model.TreatmentKitFavAddViewModelFactory
...
class FavaddTreatmentKitDialog : DialogFragment() {
    ...
    val header: com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.model.Headers =
        com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.model.Headers()
    val detailsList: ArrayList<com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.model.Detail> =
        ArrayList()
            ...
            if (!binding?.displayorderedittext?.text.toString().isEmpty()) {
                ...
                if (Str_auto_id != 0) {
                    if (status as Boolean) {
                        ...
                        val details: com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.model.Detail =
                            com.oasys.digihealth.doctor.ui.emr_workflow.treatment_kit.model.Detail()
