...
class InpatientChildFragment : Fragment() {
...
//            throw ClassCastException("Hosting activity must implement BackHandlerInterface")
    ...
    private fun setupViewPager(viewPager: ViewPager) {
        ...
        viewpageradapter!!.addFragment(InPatientActivity(), "In patient")
        viewpageradapter!!.addFragment(DischargePatientTabFragment(), "Discharge Patient")
    ...
    /*fun trackDashBoardOPMyPatientAnalyticsVisit(){
        AnalyticsManager.getAnalyticsManager().trackDashBoardOPMyPatientVisit()
    }*/
