...
class DischargePatientViewModel(application: Application?) : AndroidViewModel(
    application!!
) {
    ...
    fun getPatientListNextPage(
        ...
        searchPatientRequestModel.admission_status_uuid = 6.toString()
