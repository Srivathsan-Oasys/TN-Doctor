...
class LabNameAdapter(
    context: Context, @LayoutRes
    private val layoutResource: Int,
    private val allPois: ArrayList<LabName>
) :
    ArrayAdapter<LabName>(context, layoutResource, allPois),
    Filterable {
    private var mPois: List<LabName> = allPois

    override fun getCount(): Int {
        return mPois.size
    }

    override fun getItem(p0: Int): LabName? {
        return mPois.get(p0)
    }
    ...
    override fun getFilter(): Filter {
        return object : Filter() {
            override fun publishResults(
                ...
                try {
                    mPois = filterResults.values as List<LabName>
