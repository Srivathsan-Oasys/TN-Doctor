            ...
            if (bundle != null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    ...
                    if (PDFID != 0) {
                        ...
                        viewModel?.labPDFdownload(PDFID, GetPDFRetrofitCallback)
        ...
        binding!!.closeImageView.setOnClickListener {
            ...
            when (from) {
                ...
                "process" -> {
                    ...
                    val labtemplatedialog = LabTestProcessActivity()
                ...
                "approval" -> {
                    ...
                    val labtemplatedialog = LabTestApprovalActivity()
